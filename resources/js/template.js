...
class aiaaBanner extends HTMLElement {
    connectedCallback() {
        ...
        <video loop muted autoplay poster="../../need-review/assets/titleVideo.jpg" class="fullscreen-bg__video">
            <source src="../../need-review/assets/titleVideo.mp4" type="video/mp4">
